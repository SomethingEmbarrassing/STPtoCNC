...
- Trim rule (current helper): if the **last piece ends with cope/fishmouth/saddle**, apply `0.25 in` trim; flat/straight/miter -> `0.0 in`.
  - TODO: wire this to real end-condition detection from parsed features.
